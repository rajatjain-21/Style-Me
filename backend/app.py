...
def style_image_with_emotion():
    if(request.method == "POST"):
        ...
        c_i  = Image.open('content_image.jpg')
        c_i.save("/home/shahidikram0701/mysite/static/content_image.jpg", quality=20, optimise=True)
...
def style_image():
    if(request.method == "POST"):
        ...
        emotion = get_emotion({"image": image_result}) #emotions[e]
        image_result.close()
